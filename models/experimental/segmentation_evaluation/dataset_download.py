...
TARGET_FOLDER = "models/experimental/functional_vanilla_unet/demo/imageset"
...
os.makedirs("models/experimental/functional_vanilla_unet/demo/pred_image_set", exist_ok=True)
