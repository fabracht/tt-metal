...
#define MEM_ERISC_MAILBOX_SIZE 12928
#define MEM_ERISC_KERNEL_CONFIG_SIZE (25 * 1024)
#define MEM_ERISC_LAUNCH_FLAG_SIZE 4
...
#define MEM_ERISC_MAX_SIZE                                                                                 \
    (512 * 1024 - MEM_SYSENG_RESERVED_SIZE - MEM_ERISC_L1_BARRIER_SIZE - MEM_ERISC_APP_ROUTING_INFO_SIZE - \
     MEM_ERISC_SYNC_INFO_SIZE - MEM_ERISC_FABRIC_ROUTER_CONFIG_SIZE - MEM_ERISC_LAUNCH_FLAG_SIZE - MEM_ERISC_LOCAL_SIZE)
