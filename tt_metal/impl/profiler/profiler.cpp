    ...
    auto process_fabric_event_group_if_valid =
        ...
        try {
            ...
            if (KernelProfilerNocEventMetadata::isFabricUnicastEventType(noc_xfer_type.value())) {
                ...
                modified_write_event["mcast_start_x"] = fabric_event.at("mcast_start_x").get<int>();
                modified_write_event["mcast_start_y"] = fabric_event.at("mcast_start_y").get<int>();
                modified_write_event["mcast_end_x"] = fabric_event.at("mcast_end_x").get<int>();
                modified_write_event["mcast_end_y"] = fabric_event.at("mcast_end_y").get<int>();
            }
